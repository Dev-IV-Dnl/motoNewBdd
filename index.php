      ...
      <ul class="navbar-nav me-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu">
            <a class="dropdown-item" href="./index.php?page=ajout-article">Ajout Article</a>
            <a class="dropdown-item" href="./index.php?page=ajout-produit">Ajout Produit</a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="#">Modifier Article</a>
            <a class="dropdown-item" href="#">Modifier Produit</a>
          </div>
        </li>
      </ul>
      <form class="d-flex">
